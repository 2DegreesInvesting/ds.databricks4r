...
Databricks the things they already do elsewhere -- mainly un RStudio and the
Terminal.
...
typically do in RStudio, and not in the way you're used to. For example, it
changes the way you install some software, read, and manipulate data.
Recognizing the intended use of Databricks is crucial to avoid mistakes and
friction.
...
This chapters overviews Databricks from the perspective of an RStudio user:
...
This chapters focuses on workflows common to analysts working in RStudio:
...
This chapters focuses on workflows common to developers working in RStudio:
